...
@interface IMCircularSlider (private)

@property (readonly, nonatomic) CGFloat radius;

@end

@implementation IMCircularSlider {
    int angle;
    int fixedAngle;
...
- (void)defaults {
    ...
    _unfilledColor = [UIColor colorWithRed:141.0/255.0 green:213.0/255.0 blue:246.0/255.0 alpha:0.7];
    _filledColor = [UIColor colorWithRed:48.0/255.0 green:145.0/255.0 blue:211.0/255.0 alpha:1];
...
//    if (angle >= 0 && valueDifference >= 100) {
//        return NO;
//    }
